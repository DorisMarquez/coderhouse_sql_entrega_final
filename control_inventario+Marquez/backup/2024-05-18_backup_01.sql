...
--
-- Host: 127.0.0.1    Database: control_inventario
-- ------------------------------------------------------
...
CREATE TABLE `areas` (
  ...
  PRIMARY KEY (`id_area`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Describe las diferentes áreas que conforman la empresa';
...
INSERT INTO `areas` VALUES (1,'Gerencia y administración'),(2,'Producción'),(3,'Operaciones'),(4,'Mantenimiento'),(5,'Seguridad'),(6,'RRHH'),(7,'Logística');
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Describe las distintas categorías en que se clasifican lo productos en el almacén';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Registra los productos y las cantidades que ingresan al almacén';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Registra los productos y las cantidades que salen del almacén';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Contiene la información de los empleados de la empresa';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `empleados` VALUES (1,'Powell','Saill','psaill3b@netvibes.com',1,'Gerente'),(2,'Agnese','Ouslem','aouslem3c@photobucket.com',1,'Administrador'),(3,'Barret','Gerran','barret.gerran@empresa11.com',1,'Auxiliar de administración'),(4,'Keslie','Furley','kfurley3d@woothemes.com',2,'Auxiliar de producción'),(5,'Saba','Hissie','shissie3e@amazonaws.com',3,'Auxiliar de operaciones'),(6,'Roddie','Voelker','rvoelker3f@phoca.cz',4,'Auxiliar de mantenimiento'),(7,'Fletch','Oels','foels3g@illinois.edu',5,'Auxiliar de SHI'),(8,'Conni','Larrat','clarrat3h@whitehouse.gov',6,'Auxiliar de RRHH'),(9,'Genvieve','Segebrecht','gsegebrecht3i@altervista.org',7,'Jefe almacén'),(10,'Lavinie','Perkis','lperkis3j@newyorker.com',7,'Encargado de almacén'),(11,'Garrick','Warden','gwarden3k@fastcompany.com',7,'Encargado de almacén'),(12,'Guntar','Piccop','gpiccop3l@chron.com',7,'Encargado de almacén'),(13,'Christopher','Pechell','christopher.pechell@empresa10.com',7,'Encargado de almacén');
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Registra las guías que son recibidas en el almacén';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `productos` VALUES (1,'descripción_producto_1',4,2,1),(2,'descripción_producto_2',1,5,4),(3,'descripción_producto_3',7,5,2),(4,'descripción_producto_4',10,2,1),(5,'descripción_producto_5',1,6,9),(6,'descripción_producto_6',9,1,4),(7,'descripción_producto_7',7,6,9),(8,'descripción_producto_8',8,6,5),(9,'descripción_producto_9',10,1,7),(10,'descripción_producto_10',1,2,3);
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Registra las solicitudes de materiales hechas por las diferentes áreas de la empresa';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Describe las diferentes ubicaciones en que se encuentra organizado el almacén';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
/*!50003 DROP FUNCTION IF EXISTS `fn_1_total_entradas` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `fn_1_total_entradas`( id_prod INT ) RETURNS int
    DETERMINISTIC
BEGIN
DECLARE total INT;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP FUNCTION IF EXISTS `fn_2_total_salidas` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `fn_2_total_salidas`(id_prod INT) RETURNS int
    DETERMINISTIC
BEGIN
DECLARE total INT;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP FUNCTION IF EXISTS `fn_3_actualizar_ultimo_precio` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `fn_3_actualizar_ultimo_precio`(id_prod INT) RETURNS decimal(10,2)
    DETERMINISTIC
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP FUNCTION IF EXISTS `fn_4_valor_total_inventario` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `fn_4_valor_total_inventario`() RETURNS decimal(10,2)
    DETERMINISTIC
BEGIN
DECLARE total INT;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_1_insertar_producto` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_1_insertar_producto`(
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_2_registrar_entrada` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_2_registrar_entrada`(
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_3_registrar_salida` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_3_registrar_salida`(
...
-- Dump completed on 2024-05-18  8:19:47
